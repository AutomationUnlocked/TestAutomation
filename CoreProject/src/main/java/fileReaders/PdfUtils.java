...
public class PdfUtils {
    ...
    private boolean comparePdfFiles(String file1, String file2, int startPage, int endPage) throws IOException {
        Log.link("expected File : ", file1);
        Log.link("actual File : ", file2);
     ...
     * @throws IOException when file is not found.
     */
    public ArrayList<String> savePdfAsImage(String file, int startPage) throws IOException {
     ...
     * @throws IOException when file is not found.
     */
    public ArrayList<String> savePdfAsImage(String file, int startPage, int endPage) throws IOException {
     ...
     * @throws IOException when file is not found.
     */
    public ArrayList<String> savePdfAsImage(String file) throws IOException {
     ...
     * @return
     */
    private ArrayList<String> saveAsImage(String file, int startPage, int endPage) throws IOException {
    ...
    private boolean convertToImageAndCompare(String file1, String file2, int startPage, int endPage) throws IOException {
        ...
        try {
            ...
            for (int iPage = startPage - 1; iPage < endPage; iPage++) {
                ...
                String partName = fileName + "_diff.png";
                imagePathList.add(partName);
                fileName = this.getImageDestinationPath() + "/" + partName;
                ...
                result = ImageUtils.compareAndHighlight(image1, image2, fileName, this.bHighlightPdfDifference, this.imgColor.getRGB()) && result;
                if (!this.bCompareAllPages && !result) {
                    break;
                }
            }
            CoreVariables.setImagePaths(imagePathList);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            doc1.close();
     ...
     * @throws IOException when file is not found.
     */
    public ArrayList<String> extractImages(String file, int startPage) throws IOException {
     ...
     * @throws IOException when file is not found.
     */
    public ArrayList<String> extractImages(String file, int startPage, int endPage) throws IOException {
     ...
     * @throws IOException when file is not found.
     */
    public ArrayList<String> extractImages(String file) throws IOException {
     ...
     * @return
     */
    private ArrayList<String> extractimages(String file, int startPage, int endPage) {
...
/*            File sourceFile = new File(file);
            ...
            this.imageDestinationPath = CoreConstants.pathToExtentReports;
